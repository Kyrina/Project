...
/* Demo Background */
body{
    background:url(../Kyrina/images/banner2.jpg);
...
<div class="container">
 ...
 <form class="form-horizontal" method="POST" action="auto.php">
 <span class="heading">АВТОРИЗАЦІЯ</span>
 <div class="form-group">
 <input type="login" class="form-control" id="inputLogin" name="login"  placeholder="Логін">
 ...
 <button type="submit" name="log_in" class="btn btn-default">ВХІД</button>
 </div>
 </form>
 </div>
